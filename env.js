 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.mobile_rn.staging
 */

const BUNDLE_ID = 'com.monjob.com'; // ios bundle id
const PACKAGE = 'com.monjob'; // android package name
const NAME = 'monjob'; // app name
const EXPO_ACCOUNT_OWNER = 'ibile'; // expo account owner
